    ...
    return (
        <>
            <div className="flex flex-col h-full w-[22vw] bg-dark-beige p-5 gap-5
                ...
                <div className="flex flex-row menu-item" onClick={() => navigate("dashboard")}>
                    <img src={HomeIcon} alt = "UserView Icon" className="h-[3vh]"/>
                    <span>Dashboard</span>
                </div>
                <div className="flex flex-row menu-item" onClick={() => navigate("users")}>
                    <img src={UserIcon} alt = "Users Icon" className="h-[3vh]"/>
                    <span>Users</span>
                </div>
                <div className="flex flex-row menu-item">
                    <img src={TransactionIcon} alt = "Transactions Icon" className="h-[3vh]"/>
